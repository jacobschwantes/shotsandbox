  ...
  return (
    <>
      ...
      <div className="p-6 bg-zinc-50 min-h-screen ">
        <Modal heading="Add folder" open={openFolder} setOpen={setOpenFolder}>
        ...
        <div className="flex justify-between">
                    ...
                    return (
                      <div className="py-5 space-y-10 w-full">
                        ...
                        <div className=" w-full space-y-5 ">
                          ...
                          <div className="grid grid-cols-3 lg:grid-cols-3 2xl:grid-cols-6  gap-6 w-full">
                            {projects.map((item) => (
                            ...
                            <div className="relative group border rounded-xl space-x-3 p-5 bg-white hover:bg-zinc-100 min-h-[125px] flex  items-center justify-center  transition-all duration-300 cursor-pointer">
                              <div className="absolute group-hover:flex hidden top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-white p-2 rounded-lg flex-col space-y-1 min-w-[50%] border border-zinc-300 shadow-xl">
                                <Link href="/editor">
                                  <button className=" hover:bg-zinc-100 rounded-lg font-medium text-zinc-800 py-2 px-3 w-full text-center duration-200 transition-all">
                                    Blank
          ...
          <div className="flex items-start space-x-2">
            ...
            <button onClick={() => setOpenProject(true)} className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:ring-offset-black transition-all duration-300 ">
