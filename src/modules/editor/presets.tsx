  ...
  },
  {
    ...
    icon: ({ className }: Partial<React.SVGProps<SVGElement>>) => (
      <svg
        ...
        viewBox="0 0 24 24"
        className={clsx(
          "text-white h-6 w-6 bg-pink-500 rounded p-0.5",
          className
        )}
      >
        <path
  ...
  },
  {
    ...
    icon: ({ className }: Partial<React.SVGProps<SVGElement>>) => (
      <svg
        ...
        viewBox="0 0 24 24"
        className={clsx(
          "text-white h-6 w-6 bg-pink-400 rounded p-0.5",
          className
        )}
      >
        <path
  ...
  },
  {
    ...
    icon: ({ className }: Partial<React.SVGProps<SVGElement>>) => (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
        className={clsx("text-white h-6 w-6 bg-black rounded p-1", className)}
      >
