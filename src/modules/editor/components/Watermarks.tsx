      ...
      {theme === "light" && (
        <span
          ...
          className={clsx(
            ...
            placement && "absolute",
            "bg-white px-3 py-2 rounded-xl border-2 border-zinc-200 shadow-xl z-10 flex space-x-1 items-center bg-opacity-80 text-black"
          )}
        >
      ...
      {theme === "dark" && (
        <span
          ...
          className={clsx(
            placement && positions[placement],
            placement && "absolute",
            "bg-black px-3 py-2 rounded-xl border-2 border-zinc-600 shadow-xl z-10 flex space-x-1 items-center bg-opacity-80 text-zinc-300"
          )}
        >
          <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none">
          ...
          <h1 className="lowercase text-2xl">Screenshotify</h1>
        </span>
      )}
    </>
  )
